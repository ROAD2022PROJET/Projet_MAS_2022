...
public class Sous_Probleme_2 {
	...
	public Sous_Probleme_2(Données data, Integer _max_deviation ) throws IloException
	{
	...
	{
		// init les _i (ou comme je les ai appelé 'b_i'  pour pas qu'il y ait de confusion)
	...
	{
		// la contrainte (a capacité reduite) 
